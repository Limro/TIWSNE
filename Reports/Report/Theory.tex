...
When comparing the radio current (23 mA) with the processing current (1.8 mA), it is clear that it is better to process data before sending it. 
Processing data in order to reduce package size or transmission rate is the basis principle of this mini project. 
