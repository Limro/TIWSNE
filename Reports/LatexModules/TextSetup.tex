...
\setlist{noitemsep}
\setlist[itemize]{topsep=-10pt} % Space before \begin{itemize}
% \setlist[itemize]{leftmargin=*} % Left margin
% \setlist[itemize,1]{label=$\triangleleft$} % New symbol instead of bullet
%-------------------------------------------------------------------
